...
import com.wl.ui.banner.transformer.ZoomOutPageTransformer;
...
public class Banner extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    private int mIndicatorSelectedResId = R.drawable.banner_point_selected;
    private int mIndicatorUnselectedResId = R.drawable.banner_point_normal;
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        mIndicatorSelectedResId =typedArray.getResourceId(R.styleable.Banner_indicator_drawable_selected, R.drawable.banner_point_selected);
        mIndicatorUnselectedResId =typedArray.getResourceId(R.styleable.Banner_indicator_drawable_unselected, R.drawable.banner_point_normal);
        defaultImage =typedArray.getResourceId(R.styleable.Banner_default_image, defaultImage);
        delayTime = typedArray.getInteger(R.styleable.Banner_delay_time, BannerConfig.TIME);
    ...
    private void setImageList(List<String> imagesUrl, OnLoadImageListener imageListener) {
        ...
        initDisplayImageView(imagesUrl);
    ...
    protected void initDisplayImageView(List<String> imagesUrl) {
        if(count == 1) { //modify by wangliang 一张的时候不做无限滑动处理
            String url = imagesUrl.get(0);
            View iv = generImageView();
...
//            params.width = Banner.this.getLayoutParams().width;
//            params.height = Banner.this.getLayoutParams().height;
            container.addView(imageViews.get(position));
            final View view=imageViews.get(position);
    ...
    public interface OnLoadImageListener {
        void onLoadImage(View view, String url);
    }
}
